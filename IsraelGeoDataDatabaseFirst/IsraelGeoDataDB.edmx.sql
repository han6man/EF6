...
-- --------------------------------------------------
-- Date Created: 07/02/2019 10:57:28
-- Generated from EDMX file: C:\Users\Evgeny\source\repos\EF6\IsraelGeoDataDatabaseFirst\IsraelGeoDataDB.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_dbo_Cities_dbo_LishkotMana_lishkat_mana_code]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Cities] DROP CONSTRAINT [FK_dbo_Cities_dbo_LishkotMana_lishkat_mana_code];
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_Cities_dbo_Muacot_muaca_ezorit_code]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Cities] DROP CONSTRAINT [FK_dbo_Cities_dbo_Muacot_muaca_ezorit_code];
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_Cities_dbo_Regions_region_code]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Cities] DROP CONSTRAINT [FK_dbo_Cities_dbo_Regions_region_code];
GO
IF OBJECT_ID(N'[dbo].[FK_dbo_Streets_dbo_Cities_city_code]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Streets] DROP CONSTRAINT [FK_dbo_Streets_dbo_Cities_city_code];
GO
...
GO
IF OBJECT_ID(N'[dbo].[LishkotMana]', 'U') IS NOT NULL
    DROP TABLE [dbo].[LishkotMana];
GO
IF OBJECT_ID(N'[dbo].[Muacot]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Muacot];
GO
...
CREATE TABLE [dbo].[LishkotMana] (
    [lishkat_mana_code] int  NOT NULL,
    [lishka] nvarchar(50)  NULL
);
GO

-- Creating table 'Muacot'
CREATE TABLE [dbo].[Muacot] (
    [muaca_ezorit_code] int  NOT NULL,
    [muaca_name] nvarchar(50)  NULL
);
GO
...
ALTER TABLE [dbo].[Cities]
ADD CONSTRAINT [FK_dbo_Cities_dbo_Regions_region_code]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_dbo_Cities_dbo_Regions_region_code'
CREATE INDEX [IX_FK_dbo_Cities_dbo_Regions_region_code]
ON [dbo].[Cities]
    ([region_code]);
GO
...
ALTER TABLE [dbo].[Streets]
ADD CONSTRAINT [FK_dbo_Streets_dbo_Cities_city_code]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_dbo_Streets_dbo_Cities_city_code'
CREATE INDEX [IX_FK_dbo_Streets_dbo_Cities_city_code]
ON [dbo].[Streets]
    ([city_code]);
GO
